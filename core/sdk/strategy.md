...
- `core/sdk/manifests/` 下的结构化清单文件体积可能较大，只适合按需查询，不适合整体加载。
- `core/sdk/manifests/methods.json` 为全量方法级兜底清单，优先用于“已通过索引缩小范围后的精确定位”。
...
- 类名问题 -> `core/sdk/indexes/class-index.md`
- 包或模块问题 -> `core/sdk/indexes/package-index.md`、`core/sdk/indexes/module-index.md`
- 场景问题 -> `core/sdk/indexes/scenario-index.md`
- 关键词问题 -> `core/sdk/indexes/keyword-index.md`
- 报错问题 -> `core/sdk/indexes/error-index.md`
- 插件或扩展点问题 -> `core/sdk/indexes/plugin-index.md`
- 微服务问题 -> `core/sdk/indexes/microservice-index.md`
- 方法问题 -> `core/sdk/indexes/method-index.md`
...
- `core/sdk/manifests/summary.json`
- `core/sdk/manifests/modules.json`
- `core/sdk/manifests/packages.json`
- `core/sdk/manifests/types.json`
- `core/sdk/manifests/const-exports.json`
- `core/sdk/manifests/namespaces.json`
- `core/sdk/manifests/methods.json`（如本地或发布资产中存在）
